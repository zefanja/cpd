...
- **Kurzhospitation (15–20 min)** durch Coach, fokussiert auf den aktuellen Action Step (nicht auf alles!).
- **Auswertungsgespräch (30 min)**, Struktur:
  1. *Erfolg würdigen* (konkret, auf den letzten Action Step bezogen)
  2. *Probe/Fokus*: gemeinsam eine kurze Videosequenz oder Beobachtungsnotiz ansehen
  3. *Neuen Action Step ableiten* (klein, präzise, in 1 Woche machbar, formuliert als „Wenn X, dann tue Y")
  4. *Üben im Gespräch*: den Action Step 2–3× laut durchspielen (Rollenspiel), bevor er im Unterricht kommt
...
- **Lehrportfolio** (wächst wöchentlich): Action-Step-Log, 3 gefilmte Eigenanalysen (Woche 1 [Baseline], 7, 19, 33), Skriptsammlung, Exit-Ticket-Auswertungen.
- **Meilenstein-Gespräche** nach Block 1 (W7), Block 3 (W19) und Block 6 (W35) (Selbst- und Fremdeinschätzung anhand einer Kompetenzmatrix; Vollerhebung der Matrix in W0/W19/W35, Teil-Updates in W7/W13/W25/W30).
- **Abschluss-Kolloquium** (Woche 35): Präsentation der eigenen Entwicklung anhand von zwei Videoausschnitten (früh vs. spät).
...
- **SPA-Bausteine** – konkrete Ideen für interaktive Elemente der Selbstlern-App
...
3b. **Warm/Strict (Lemov T61) als wichtigste Registeranwendung:** warmer Ton + unverhandelbare Sache im selben Satz („Weil ich weiß, dass du das besser kannst, nehme ich das so nicht an"). Steht hier und nicht in Woche 6, weil es genau genommen kein Wortschatz, sondern ein Registerwechsel ist.
...
**Kernideen:**
1. **After-Class Conversation / W.I.N. (Lovell R6):** Strukturierte Kurzgespräche nach der Stunde: **W**as ist passiert? (der Schüler zuerst, Stille aushalten) – Welchen **I**mpact hatte es? (sachlich, keine Moralkeule) – **N**ächste Schritte (gemeinsam, konkret, klein). Ruhig, privat, zukunftsgerichtet.
...
- **Ein Modul = eine Kernidee.** Alles Weitere ist Vertiefung hinter einem Klick.
- **Reihenfolge fix: See it → Name it → Do it.** Erst Beispiel, dann Begriff/Zerlegung, dann Übung. Nie mit Theorie-Text beginnen.
- **Fehlvorstellungen als Quiz-Distraktoren** nutzen (in jedem Modul oben gelistet).
- **Jedes Modul endet mit einem Action-Step-Formular** (vorformulierte Vorschläge + Freitext), nicht mit einer Zusammenfassung.
- **Kumulative Quizfragen:** Jedes Modulquiz enthält 30 % Fragen aus früheren Modulen.
- **Maximal 20–25 Minuten Bearbeitungszeit** pro Modul-SPA – der Rest gehört ins Klassenzimmer.

## Kompetenzmatrix (Vorschlag: 8 Felder für Selbst-/Fremdeinschätzung)
1. Routinen & Stundenstart · 2. Anweisungen & Aufmerksamkeit · 3. Intervention & Präsenz · 4. Erklären & Modellieren · 5. Übungsphasen führen & monitoren · 6. Verstehen prüfen (CFU) · 7. Beteiligung & Fragenkultur · 8. Planung & Arbeitsökonomie
(je 4 Stufen: Anfang – Grundlagen – sicher – flüssig/adaptiv)

## Quellenverzeichnis (Kern)
- Lemov, D. (2021). *Teach Like a Champion 3.0.* Jossey-Bass. [Projektquelle]
- Lovell, O. & Dowley, M. *The Classroom Management Handbook.* John Catt. [Projektquelle]
- McCrea, P. *Lean Lesson Planning* / *Memorable Teaching* / *Motivated Teaching.* [Projektquellen]
- Rosenshine, B. (2012). Principles of Instruction. *American Educator*, 36(1).
- EEF (2021). *Effective Professional Development. Guidance Report.* (Sims et al.)
- Bambrick-Santoyo, P. (2016/2024). *Get Better Faster (2.0).* Jossey-Bass. (Sequenzierungs- & Coaching-Modell)
- Ergänzend für Jahr 2: Willingham, *Why Don't Students Like School?*; Wiliam, *Embedded Formative Assessment*; Sherrington & Caviglioli, *Teaching WalkThrus*; Lemov et al., *Practice Perfect*.
