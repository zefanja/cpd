...
- **Lehrportfolio** (wächst wöchentlich): Action-Step-Log, 3 gefilmte Eigenanalysen (Woche 8, 20, 34), Skriptsammlung, Exit-Ticket-Auswertungen.
- **Meilenstein-Gespräche** nach Block 1, 3 und 6 (Selbst- und Fremdeinschätzung anhand einer Kompetenzmatrix).
- **Abschluss-Kolloquium** (Woche 36): Präsentation der eigenen Entwicklung anhand von zwei Videoausschnitten (früh vs. spät).
...
3. **After-Class Conversation / W.I.N. (Lovell R6):** Strukturierte Kurzgespräche nach der Stunde: **W**as ist passiert? – Welchen **I**mpact hatte es? – **N**ächste Schritte. Ruhig, privat, zukunftsgerichtet.
