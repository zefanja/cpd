...
**Raum:** Einzelarbeitsplätze mit Diskretion, dann Tandems. **Vorab-Auftrag (W28-Exit-Karte):** Sitzplan der schwierigsten Klasse mitbringen.
...
# 4. Coaching-Woche 29 (Handreichung)

- **Hospitationsfokus – die Beziehungs-Heatmap:** Coach protokolliert eine Stunde lang jeden persönlichen Kontakt der Lehrkraft (Name + Art: fachlich/persönlich/korrigierend) auf dem Sitzplan – die Beziehungs-Schicht zur W22-Heatmap.
...
- **Verzahnung:** W27-Fall checken – ist er rot in der Inventur? (Häufig ja: E-Engpass und Unsichtbarkeit korrelieren.) Dann Mikromomente ALS Teil der EVK-Maßnahme rahmen.
...
1. Die Kosten-Frage bei K-Engpass (W28)? *(„Welche meiner Routinen erreicht diesen Schüler noch nicht?")*
...
4. Die EVK-Diagnose-Reihenfolge (W27)? *(E prüfen → K senken → W heben)*
...
## Teil 2: Modul-Quiz Woche 29 (für SPA/Folgewoche)
...
# Anhang 3: Ableitung für die SPA „Modul 29"
...
4. **Do it – Inventur-Tool (9 Min., Kern-Engine!):** Sitzplan-Editor (aus Modul 13/22/24 wiederverwendet!) mit Ampel-Markierung; App legt automatisch die Modul-22-Heatmap-Daten als Vergleichsschicht darüber (Deckungs-Analyse: „3 deiner Roten sind auch Beteiligungs-Kaltzonen"); ALLE Daten bleiben lokal – prominenter Datenschutz-Hinweis.
5. **Mikromoment-Planer:** die 3-Zeilen-Vorlage mit Echtheits-Check-Prompt und Tages-Erinnerung; der Modul-27-Fall wird automatisch eingeblendet, falls gespeichert („Dein EVK-Fall – auch rot?").
