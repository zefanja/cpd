# Skript Woche 32: „Einheiten rückwärts – von der Klassenarbeit zur Stundenkette"
...
**Raum:** Einzelarbeitsplätze + Tandems. **Vorab-Auftrag (W31-Exit-Karte):** Termin + Thema der nächsten eigenen Klassenarbeit mitbringen.
...
> *​**Schritt zwei: Meilensteine der Einheit.** Aus der Skizze fallen sie heraus: vier bis sechs Könnens-Stationen, kumulativ – dieselbe Ampel wie in Woche 9, eine Ebene höher.*
...
- **Format: Planungsgespräch (wie W31)** – diesmal auf Einheitsebene: Canvas gemeinsam durchgehen; die drei Härtetest-Fragen stellen; besonders prüfen: Ist die Arbeits-Skizze wirklich VOR der Kette entstanden (oder nachträglich drübergelegt)?
...
- **Red Flag:** TN baut den Canvas als starres Raster und „zieht ihn durch", obwohl Tickets Alarm schlagen → die Bleistift-Metapher schärfen: Der Canvas ohne Inter-Lesson-Planning ist der Abdeckungsfokus (W9) im neuen Gewand.
...
Raster: Phase | Ich tue … | **ALLE Schüler tun … (konkret, prüfbar!)** — **Typische Passivitätslöcher:** während der Erklärung (Füller: Notier-Auftrag/Beachtungs-Auftrag W16) · während Einzelne antworten (Füller: „Alle prüfen mit: Daumen/Boards") · während der Besprechung (Füller: Selbstkorrektur mit grünem Stift + Fehlerjournal) · beim Austeilen/Umbau (Füller: Mini-Retrieval an der Tafel) · nach dem Fertigwerden (Füller: Was-wenn-fertig, W12!).
...
c) Schwache bekommen leichtere Ziele ✗ *(die Absenkungs-Falle – W1/W6-Echo!)*
...
4. **Do it – Canvas-Builder (10 Min., Kern-Engine!):** digitaler Einheiten-Canvas mit erzwungener Reihenfolge (Kette erst nach Arbeits-Skizze freigeschaltet – dieselbe UI-Logik wie Modul 31); Puffer-Pflichtfeld; Spacing-Anker als Checkbox-Zeile (verzahnt mit dem Modul-18-Spacing-Planer!); Inter-Lesson-Tagesnotiz-Feld je Stunde mit Abend-Erinnerung (5-Min.-Timer).
...
6. **Kern+Rampe-Konfigurator:** Meilenstein eingeben → Gerüst-Optionen (aus Fading-Bibliothek Modul 11) + Stretch-Optionen (aus Fächer Modul 19/22) zusammenstellen; Ausstiegsplan-Pflichtfeld fürs Gerüst.
