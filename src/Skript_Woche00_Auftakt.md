...
- Noch keine Hospitation. Stattdessen: 20-Min.-Kennenlerngespräch pro TN (Biografie, Fächer, Klassen, größte aktuelle Sorge).
- Zielvereinbarung + Kompetenzmatrix entgegennehmen, NICHT kommentieren oder relativieren – nur eine Rückfrage stellen: „Was davon ist am dringendsten?"
- Logistik: Baseline-Video-Termin für Woche 1 fixieren; Coaching-Jour-fixe in den Stundenplan.
- Red Flags notieren (akute Notlagen → ggf. Werkzeuge aus W4/W6 im 1:1 vorziehen, Absprache mit Moderation).
...
- Mein wichtigstes Ziel für dieses Jahr (eigene Worte): …
